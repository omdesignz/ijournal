...
<div class="space-y-1">
                ...
                <div class="space-y-1">
                  ...
                  <input value="1" id="active" name="active" type="checkbox" class="focus:ring-isptec h-4 w-4 text-isptec border-gray-300 rounded-full">
...
<li>
    <a href="#" class="block hover:bg-gray-50">
        ...
        <div class="mt-2 flex justify-between">
            ...
            <input value="{{ $role->id }}" id="role-{{ $role->id }}" name="roles[]" type="checkbox" class="focus:ring-isptec h-4 w-4 text-isptec border-gray-300 rounded-full">
            </div>
        </div>
        </div>
    </a>
