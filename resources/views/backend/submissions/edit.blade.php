...
<form method="post" action="{{ url('submissions') . '/' . $article->id }}" class="space-y-8 divide-y divide-gray-200" enctype="multipart/form-data">
    @method('PUT')
    @csrf
  <div class="space-y-8 divide-y divide-gray-200">
    <div>
      ...
      <div class="sm:col-span-3">
          ...
          <div class="mt-1">
            <input value="{{ $article->title }}" type="text" name="title" id="title" autocomplete="given-name" class="shadow-sm focus:ring-isptec focus:border-isptec block w-full sm:text-sm border-gray-300 rounded-md">
          </div>
          @if($errors->has('title'))
        ...
        <div class="sm:col-span-6">
          ...
          <div class="mt-1" x-data="{content: '{{ $article->abstract }}', limit: $refs.abstract.maxLength}">
            <textarea x-model="content" x-ref="abstract" maxlength="280" id="abstract" name="abstract" rows="3" class="shadow-sm focus:ring-isptec focus:border-isptec block w-full sm:text-sm border border-gray-300 rounded-md"> </textarea>
        ...
        <div class="sm:col-span-6">
          ...
          <div class="mt-1">
            <textarea id="references" name="references" rows="3" class="shadow-sm focus:ring-isptec focus:border-isptec block w-full sm:text-sm border border-gray-300 rounded-md">{{ $article->references }}</textarea>
          </div>
        ...
        <div class="sm:col-span-6">
          ...
          <div class="mt-1">
            <input value="{{ $article->keywords }}" type="text" name="keywords" id="keywords" autocomplete="keywords" class="shadow-sm focus:ring-isptec focus:border-isptec block w-full sm:text-sm border-gray-300 rounded-md">
          </div>
        ...
        <div class="sm:col-span-6">
          ...
          <div class="mt-1">
            <input value="{{ $article->authors }}" type="text" name="authors" id="authors" autocomplete="authors" class="shadow-sm focus:ring-isptec focus:border-isptec block w-full sm:text-sm border-gray-300 rounded-md">
          </div>
        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-1">
            <input value="{{ $article->published_at }}" type="date" name="published_at" id="published_at" autocomplete="published_at" class="shadow-sm focus:ring-isptec focus:border-isptec block w-full sm:text-sm border-gray-300 rounded-md">
          </div>
        ...
        <!-- <div class="sm:col-span-6">
          ...
          <div class="mt-1">
            <textarea id="cite_instructions" name="cite_instructions" rows="3" class="shadow-sm focus:ring-isptec focus:border-isptec block w-full sm:text-sm border border-gray-300 rounded-md">{{ $article->cite_instructions }}</textarea>
          </div>
          ...
          <div class="mt-4 space-y-4">
            <div class="relative flex items-start">
              <div class="flex items-center h-5">
                <input value="1" id="agree_terms" name="agree_terms" type="checkbox" class="focus:ring-isptec h-4 w-4 text-isptec border-gray-300 rounded-full" {{ $article->agree_terms == 1 ? 'checked' : '' }}>
              </div>
            ...
            <div class="relative flex items-start">
              <div class="flex items-center h-5">
                <input value="1" id="agree_privacy_policy" name="agree_privacy_policy" type="checkbox" class="focus:ring-isptec h-4 w-4 text-isptec border-gray-300 rounded-full" {{ $article->agree_privacy_policy == 1 ? 'checked' : '' }}>
              </div>
              <div class="ml-3 text-sm">
