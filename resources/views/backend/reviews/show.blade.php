...
<div class="bg-white shadow overflow-hidden sm:rounded-lg">
  <div class="px-4 py-5 sm:px-6">
    ...
    <p class="mt-1 max-w-2xl text-sm text-gray-500">
      A brief overview of the selected review.
    </p>
  </div>
  <div class="border-t border-gray-200">
    <dl>
      ...
      <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        ...
        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
          {{ $review->article->user->first_name }} {{ $review->article->user->last_name }}
        </dd>
      </div>
      <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        <dt class="text-sm font-medium text-gray-500">
          ...
          <ul role="list" class="border border-gray-200 rounded-md divide-y divide-gray-200">
            ...
            <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
              ...
              <div class="ml-4 flex-shrink-0">
                <a href="{{ $review->article->filtered_paper }}" class="font-medium text-isptec hover:text-gray-700">
                  View
                </a>
              </div>
            </li>
            ...
            <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
              ...
              <div class="ml-4 flex-shrink-0">
                <a href="{{ $review->revised_paper }}" class="font-medium text-isptec hover:text-gray-700">
                  View
                </a>
              </div>
            </li>
