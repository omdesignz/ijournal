...
<form method="post" action="{{ route('announcements.store') }}" class="space-y-8" enctype="multipart/form-data">
@csrf
...
<div class="sm:col-span-6">
    ...
    <div class="mt-1">
    <textarea id="description" name="description" rows="3" class="shadow-sm focus:ring-isptec focus:border-isptec block w-full sm:text-sm border border-gray-300 rounded-md"></textarea>
    </div>
